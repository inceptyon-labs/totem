...
import (
	...
	"github.com/inceptyon-labs/totem/internal/cors"
	...
	"github.com/inceptyon-labs/totem/internal/web"
...
func runServer(port int, origins []string) error {
	...
	// Resolve worktree root directory (default: ~/.totem/worktrees/<project>/)
